...
for sec_id in range(1, 10):
    ...
    scores_arrays = [df_sec['logfreq'].to_numpy()]
...
np.save(f'regression_results/syntax-fmri/scores/logfreq_{subj_id}_scores.npy', regression_scores)
np.save(f'regression_results/syntax-fmri/betas/logfreq_{subj_id}_betas.npy', regression_betas)
